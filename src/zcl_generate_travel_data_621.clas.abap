CLASS zcl_generate_travel_data_621 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_621 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_621.
...
*   delete existing entries in the database table
    DELETE FROM ztravel_621.

*   insert the new table entries
    INSERT ztravel_621 FROM TABLE @itab.
